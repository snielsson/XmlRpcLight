  ...
  <params>
    <param>
      <value><string>test string</string></value>
            ...
            Assert.AreEqual(o, "test string", "retval is 'test string'");
        }
  ...
  <params>
    <param>
      <value/>
            ...
            Assert.IsTrue(o != null, "retval not null");
            Assert.IsTrue(o is string, "retval is string");
            Assert.AreEqual(o, "", "retval is empty string");
        }
  ...
  <fault>
    <value>
      <struct>
        ...
        [Test]
        public void Yolanda() {
            var xml = @"<?xml version=""1.0"" encoding=""ISO-8859-1""?><methodResponse><params><param><value><array><data><value>addressbook</value><value>system</value></data></array></value></param></params></methodResponse>";
            var sr = new StringReader(xml);
            var serializer = new XmlRpcSerializer();
            var response = serializer.DeserializeResponse(sr, null);
        ...
        [Test]
        public void Gabe() {
            var xml = @"<?xml version=""1.0"" encoding=""UTF-8""?><methodResponse><params><param><value><struct><member><name>response</name><value><struct><member><name>result</name><value><array><data><value><struct><member><name>state</name><value><string>CO</string></value></member><member><name>latitude</name><value><double>39.74147878</double></value></member><member><name>add1</name><value><string>110 16th St.</string></value></member><member><name>add2</name><value><string /></value></member><member><name>image_map</name><value><array><data><value><string>rect</string></value><value><int>290</int></value><value><int>190</int></value><value><int>309</int></value><value><int>209</int></value></data></array></value></member><member><name>city</name><value><string>Denver</string></value></member><member><name>fax</name><value><string>303-623-1111</string></value></member><member><name>name</name><value><boolean>0"
...
<name>price</name>
            ...
            var serializer = new XmlRpcSerializer();
            serializer.NonStandard = XmlRpcNonStandard.IgnoreDuplicateMembers;
            Assert.Throws< XmlRpcInvalidXmlRpcException>(()=>serializer.DeserializeResponse(sr1,
                typeof (XmlRpcStruct)));
            //var ret = (XmlRpcStruct) response.retVal;
        }
...
<value><string>284</string></value>
 ...
 <string>Airplanes</string>
            ...
            var serializer = new XmlRpcSerializer();
            serializer.NonStandard = XmlRpcNonStandard.IgnoreDuplicateMembers;
            Assert.Throws< XmlRpcTypeMismatchException>( ()=>serializer.DeserializeResponse(sr1,
                typeof (Category[])));
        }
